...
function E2(t2, e4, o4, i4) {
  ...
  if (s3) {
    const t3 = n2(s3), e5 = i4 && d2(i4) ? n2(i4) : i4;
    let o5 = t3.frameElement;
    for (; o5 && i4 && e5 !== t3; ) {
      const t4 = L2(o5), e6 = o5.getBoundingClientRect(), i5 = getComputedStyle(o5);
      e6.x += (o5.clientLeft + parseFloat(i5.paddingLeft)) * t4.x, e6.y += (o5.clientTop + parseFloat(i5.paddingTop)) * t4.y, h3 *= t4.x, p3 *= t4.y, g3 *= t4.x, m3 *= t4.y, h3 += e6.x, p3 += e6.y, o5 = n2(o5).frameElement;
    }
  }
...
function S(e4, i4, l3) {
  return "viewport" === i4 ? l(function(t2, e5) {
    ...
    let l4 = i5.clientWidth, c3 = i5.clientHeight, s3 = 0, f3 = 0;
    if (r3) {
      l4 = r3.width, c3 = r3.height;
      const t3 = x2();
      (t3 || !t3 && "fixed" === e5) && (s3 = r3.offsetLeft, f3 = r3.offsetTop);
    }
    return { width: l4, height: c3, x: s3, y: f3 };
  }(e4, l3)) : d2(i4) ? l(function(t2, e5) {
    ...
    const e5 = R(t2), n3 = T2(t2), i5 = t2.ownerDocument.body, l4 = r2(e5.scrollWidth, e5.clientWidth, i5.scrollWidth, i5.clientWidth), c3 = r2(e5.scrollHeight, e5.clientHeight, i5.scrollHeight, i5.clientHeight);
    let s3 = -n3.scrollLeft + C(t2);
    const f3 = -n3.scrollTop;
    return "rtl" === o3(i5).direction && (s3 += r2(e5.clientWidth, i5.clientWidth) - l4), { width: l4, height: c3, x: s3, y: f3 };
  }(R(e4)));
}
function A(t2) {
  return a2(t2) && "fixed" !== o3(t2).position ? t2.offsetParent : null;
}
function H(t2) {
  const e4 = n2(t2);
  let i4 = A(t2);
  for (; i4 && m2(i4) && "static" === o3(i4).position; )
    i4 = A(i4);
  return i4 && ("html" === s2(i4) || "body" === s2(i4) && "static" === o3(i4).position && !y3(i4)) ? e4 : i4 || function(t3) {
    let e5 = F(t3);
    for (; a2(e5) && !w2(e5); ) {
      if (y3(e5))
        return e5;
...
var P2 = { getClippingRect: function(t2) {
  ...
  const f3 = "clippingAncestors" === n3 ? function(t3, e5) {
    ...
    for (; d2(c4) && !w2(c4); ) {
      ...
      (l4 ? e6 || r3 : e6 || "static" !== t4.position || !r3 || !["absolute", "fixed"].includes(r3.position)) ? r3 = t4 : i4 = i4.filter((t5) => t5 !== c4), c4 = F(c4);
    }
  ...
  return { reference: O2(e4, await i4(n3), o4), floating: __spreadValues({ x: 0, y: 0 }, await r3(n3)) };
